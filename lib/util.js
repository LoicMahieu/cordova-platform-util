...
// https://github.com/driftyco/ionic/blob/ce06f6e40bdb2bc560d9241aa1ef23db4fff065f/js/utils/platform.js
...
/**
 * @ngdoc utility
 * @name cordovaPlatformUtil
 * @module cordovaPlatformUtil
 * @description
 ...
 * @usage
 * ```js
 * cordovaPlatformUtil.ready(function(){
 *   // will execute when device is ready, or immediately if the device is already ready.
 * });
 *
 * var deviceInformation = cordovaPlatformUtil.device();
 *
 * var isWebView = cordovaPlatformUtil.isWebView();
 * var isIPad = cordovaPlatformUtil.isIPad();
 * var isIOS = cordovaPlatformUtil.isIOS();
 * var isAndroid = cordovaPlatformUtil.isAndroid();
 * var isWindowsPhone = cordovaPlatformUtil.isWindowsPhone();
 *
 * var currentPlatform = cordovaPlatformUtil.platform();
 * var currentPlatformVersion = cordovaPlatformUtil.version();
 *
 * cordovaPlatformUtil.exitApp(); // stops the app
 * ```
 */
var self = module.exports = {
  ...
  /**
   * @ngdoc property
   * @name cordovaPlatformUtil#isReady
   * @returns {boolean} Whether the device is ready.
   */
  isReady: false,
  /**
   * @ngdoc property
   * @name cordovaPlatformUtil#isFullScreen
   * @returns {boolean} Whether the device is fullscreen.
   */
  isFullScreen: false,
  /**
   * @ngdoc property
   * @name cordovaPlatformUtil#platforms
   * @returns {Array(string)} An array of all platforms found.
   */
  platforms: null,
  /**
   * @ngdoc property
   * @name cordovaPlatformUtil#grade
  ...
  /**
   * @ngdoc method
   * @name cordovaPlatformUtil#ready
   * @description
  ...
  /**
   * @ngdoc method
   * @name cordovaPlatformUtil#setGrade
  ...
  /**
   * @ngdoc method
   * @name cordovaPlatformUtil#device
  ...
  /**
   * @ngdoc method
   * @name cordovaPlatformUtil#isWebView
  ...
  /**
   * @ngdoc method
   * @name cordovaPlatformUtil#isIPad
  ...
  /**
   * @ngdoc method
   * @name cordovaPlatformUtil#isIOS
  ...
  /**
   * @ngdoc method
   * @name cordovaPlatformUtil#isAndroid
  ...
  /**
   * @ngdoc method
   * @name cordovaPlatformUtil#isWindowsPhone
  ...
  /**
   * @ngdoc method
   * @name cordovaPlatformUtil#platform
  ...
  setPlatform: function(n) {
    ...
    } else if (getParameterByName('platform')) {
      platformName = getParameterByName('platform');
  ...
  /**
   * @ngdoc method
   * @name cordovaPlatformUtil#version
  ...
  /**
   * @ngdoc method
   * @name cordovaPlatformUtil#exitApp
  ...
  /**
   * @ngdoc method
   * @name cordovaPlatformUtil#showStatusBar
  ...
  /**
   * @ngdoc method
   * @name cordovaPlatformUtil#fullScreen
   * @description
...
function onPlatformReady() {
  ...
  readyCallbacks = [];
  triggerEvent(document, 'platformready');
